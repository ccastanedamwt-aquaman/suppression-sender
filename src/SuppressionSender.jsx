  ...
  return (
    <div className="app">
      ...
      <div className="content">
        ...
        {/* CITY & STATE */}
        <div className="sec">
          <div className="sec-label">City &amp; State</div>
        ...
        <div className="sec">
          ...
          <div className="time-row" style={{borderTop:"none",paddingTop:4}}>
            ...
            <span className="time-val" style={{color:"#f87171"}}>{fmtDateTime(endTime)}</span>
          </div>
        </div>
        {/* REASON */}
        <div className="sec">
        ...
        <div className="sec">
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
            <div style={{fontSize:11,color:"#666",fontFamily:"'IBM Plex Mono',monospace"}}>
              To: {testMode ? <span style={{color:"#fbbf24"}}>{profile.email}</span> : <span style={{color:"#f87171"}}>NSRM@wal-mart.com</span>}
            </div>
    ...
    <div className="app">
      <div className="hdr">
        <button onClick={props.onBack}
          style={{background:"transparent",border:"none",color:"#f87171",fontFamily:"'IBM Plex Sans',sans-serif",fontWeight:700,fontSize:14,cursor:"pointer",padding:"6px 0",marginRight:4,WebkitTapHighlightColor:"transparent"}}>
          ← Back
        </button>
        <div className="hdr-title">Edit Profile</div>
      ...
      <div className="content">
        ...
        <div className="sec">
          <div className="sec-label">Contact Phone (digits only)</div>
          <input className="field-input" type="tel" value={phone}
            onChange={function(e) { setPhone(e.target.value); }} />
        </div>
        <div className="sec">
          <div className="sec-label">Your Email <span style={{color:"#555",fontWeight:400}}>(for test sends)</span></div>
          <input className="field-input" type="email" value={email}
            onChange={function(e) { setEmail(e.target.value); }} />
        </div>
        <div style={{marginTop:8}}>
          <button className="send-btn ready" onClick={handleSave}
            disabled={!name.trim() || !phone.trim()}>
            Save Profile
          </button>
        </div>
        <div style={{marginTop:20,textAlign:"center"}}>
          <span className="settings-link" style={{color:"#333"}}
            onClick={function() {
              if (window.confirm("Reset and start onboarding over?")) {
...
export default function SuppressionSender() {
  ...
  return (
    <>
      ...
      <SuppressionApp
        profile={profile}
        onProfileUpdate={function(updated) { setProfile(updated); }}
      />
    </>
  );
}
